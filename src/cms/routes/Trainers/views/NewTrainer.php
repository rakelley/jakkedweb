...
/**
 * Composite view with form for adding trainers
 */
class NewTrainer extends \rakelley\jhframe\classes\View implements
...
<h2 class="page-heading">Add A New Trainer</h2>
<p class="page-subheading">You will be able to add a photo afterwards</p>
