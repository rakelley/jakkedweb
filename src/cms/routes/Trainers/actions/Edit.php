...
/**
 * FormAction for editing an existing trainer
 */
class Edit extends \rakelley\jhframe\classes\FormAction
{
    ...
    public function Proceed()
    {
        $this->input['visible'] = ($this->input['visible'] === 'Visible') ? 1 :
                                  0;
        $this->trainers->setTrainer($this->input);
    }
