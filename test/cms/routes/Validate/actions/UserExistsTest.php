...
/**
 * @coversDefaultClass \cms\routes\Validate\actions\UserExists
 */
class UserExistsTest extends \test\helpers\cases\Base
{
    ...
    protected function setUp()
    {
        ...
        $testedClass = '\cms\routes\Validate\actions\UserExists';
